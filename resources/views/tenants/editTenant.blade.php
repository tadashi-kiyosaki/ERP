...
@section('content')
                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="{{route('editTenant')}}" method="post" enctype="multipart/form-data" class="form-horizontal" id="editForm">
                                            @csrf
                                            ...
                                            <div class="tab-content pl-3 pt-2" id="nav-tabContent">
                                                <div class="tab-pane fade active show" id="pills-details" role="tabpanel" aria-labelledby="pills-details-tab">
                                                    ...
                                                    <div class="row form-group">
                                                        ...
                                                        <div class="col col-md-3">
                                                            <input type="text" id="text-input" name="firstName" placeholder="FirstName" class="form-control{{ $errors->has('firstName') ? ' is-invalid' : '' }}" value="{{$tenant->first_name}}" required>
                                                        ...
                                                        <div class="col col-md-3">
                                                            <input type="text" id="text-input2" name="surName" placeholder="SurName" class="form-control{{ $errors->has('surName') ? ' is-invalid' : '' }}" value="{{$tenant->sur_name}}" required>
                                                    ...
                                                    <div class="row form-group">
                                                        ...
                                                        <div class="col col-md-3">
                                                            <input type="text" id="text-input3" name="idNumber" placeholder="ID Number" class="form-control{{ $errors->has('idNumber') ? ' is-invalid' : '' }}" value="{{$tenant->id_number}}" required>
                                                    ...
                                                    <div class="row form-group">
                                                        ...
                                                        <div class="col col-md-3">
                                                            <input type="text" id="text-input4" name="pinNumber" placeholder="PIN Number" class="form-control{{ $errors->has('pinNumber') ? ' is-invalid' : '' }}" value="{{$tenant->pin_number}}" required>
                                                    ...
                                                    <div class="row form-group">
                                                        ...
                                                        <div class="col col-md-3">
                                                            <input type="text" id="text-input5" name="vatNumber" placeholder="VAT Number" class="form-control{{ $errors->has('vatNumber') ? ' is-invalid' : '' }}" value="{{$tenant->vat_number}}" required>
                                                ...
                                                <div class="tab-pane fade" id="pills-contacts" role="tabpanel" aria-labelledby="pills-contacts-tab">
                                                    <div class="row form-group">
                                                        ...
                                                        <div class="col col-md-3">
                                                            ...
                                                            <input id="primaryPhoneNumber" name="primaryPhoneNumber" type="tel" class="form-control{{ $errors->has('primaryPhoneNumber') ? ' is-invalid' : '' }}" value="{{$tenant->primary_phone_number}}" required>
                                                        ...
                                                        <div class="col col-md-3">
                                                            ...
                                                            <input id="alternatePhoneNumber" name="alternatePhoneNumber" type="tel" class="form-control" value="{{$tenant->alternate_phone_number}}">
                                                        </div>
                                                    </div>
                                                    <div class="row form-group">
                                                        <div class="col col-md-3">
                                                        ...
                                                        <div class="col col-md-3">
                                                            <input type="text" id="text-input6" name="poBox" placeholder="P.O.BOX" class="form-control{{ $errors->has('poBox') ? ' is-invalid' : '' }}" value="{{$tenant->po_box}}" required>
                                                            @if ($errors->has('poBox'))
                                                                <span class="invalid-feedback" role="alert">
                                                        ...
                                                        <div class="col col-md-3">
                                                            <input type="text" id="text-input7" name="postalCode" placeholder="Postal/ZIP Code" class="form-control{{ $errors->has('postalCode') ? ' is-invalid' : '' }}"  value="{{$tenant->postal_code}}" required>
                                                    ...
                                                    <div class="row form-group">
                                                        ...
                                                        <div class="col col-md-3">
                                                            <select id="country" name="country" placeholder="Country" class="form-control{{ $errors->has('country') ? ' is-invalid' : '' }}" value="{{$tenant->country}}">
                                                        ...
                                                        <div class="col col-md-3">
                                                            <select id="state" name="state" class="form-control{{ $errors->has('state') ? ' is-invalid' : '' }}" value="{{$tenant->state}}" required>
                                                        ...
                                                        <div class="col col-md-3">
                                                            <select id="city" name="city" class="form-control" value="{{$tenant->city}}">
                                                            </select>
                                                        </div>
                                                    </div>
                                                    <div class="row form-group">
                                                        ...
                                                        <div class="col-12 col-md-9">
                                                            <input type="email" id="email-input" name="email" placeholder="Enter Email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" value="{{$tenant->email}}" required>
                                                            @if ($errors->has('email'))
                                                                <span class="invalid-feedback" role="alert">
                                            ...
                                            <div class="card-footer">
                                                ...
                                                <a href="{{route('show_tenants')}}" class="btn btn-info btn-sm"><i class="fa fa-ban"></i>Cancel </a>
                                            </div>
                                        </form>
                                    </div>
                                </div>
    ...
    <script>
        var title = "<?php echo $tenant->title; ?>";
        var btype = "<?php echo $tenant->bill_type; ?>";
        var country = "<?php echo $tenant->country; ?>";
        var state = "<?php echo $tenant->state; ?>";
        var city = "<?php echo $tenant->city; ?>";
        var ppc = "<?php echo $tenant->primary_phone_code; ?>";
        var apc = "<?php echo $tenant->alternate_phone_code; ?>";
        var pcc = "<?php echo $tenant->primary_country_code; ?>";
        var acc = "<?php echo $tenant->alternate_country_code; ?>";
    </script>
@endsection
