                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Create Landlord</strong>
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="{{route('saveLord')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                                            @csrf
...
{{--                                                            <input type="text" id="text-input" name="town" placeholder="Town" class="form-control{{ $errors->has('town') ? ' is-invalid' : '' }}" required>--}}
    ...
    <script src="/js/createLandlord.js"></script>
@endsection
